<template>
  <a-layout id="label-to-post-index">
        ...
        <div v-if="!spinning">
          <div class="top">
            ...
            <div class="right">
              ...
              <div class="meta-post">{{ labelData.postUseCount + ' ' + $t('common.post') }}</div>
            </div>
          </div>
          <div class="bottom">
            <!-- 文章列表 -->
...
export default {
  components: {IndexHeader, FrontPagePost, FooterButtons, CustomEmpty},
  data() {
    return {
...
#label-to-post-index .content {
  margin-top: 64px;
  width: 900px;
  background: #fff;
}

#label-to-post-index .ant-layout-header, .ant-layout-content {
  display: flex;
  align-items: center;
  justify-content: center;
}

#label-to-post-index .ant-layout-header {
  background: #fff;
  height: auto;
  line-height: 2.3;
}
